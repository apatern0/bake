...
| `impl` | synthesis + place-and-route           | Yosys + OpenROAD on the SkyWater sky130 PDK | — |
| `tmr`  | triple-modular-redundancy insertion   | [tmrg](https://github.com/rlf-arlut/tmrg)  | — |

The sky130 PDK is a ~400 MB git submodule and is only needed for `impl`; see
[Installation](docs/installation.md). To enable tab-completion for the lifetime of a shell:
